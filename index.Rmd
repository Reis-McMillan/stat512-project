...
$$
\begin{aligned}
H_0: &\beta_3 = 0 | \beta_0, \beta_1, \beta_2, \beta_4, \beta_5 \\
H_a: &\beta_3 < 0 | \beta_0, \beta_1, \beta_2, \beta_4, \beta_5 
\end{aligned}
$$
...
# F-test and Reduced Model Comparison
```{r}
summary(model)
```

```{r}
model_reduced <- lm(log(crimes_per_pop) ~ pct_unemployed + pct_empl_manu +
              pct_occup_manu + pct_occup_mgmt_prof, data = model_data)
